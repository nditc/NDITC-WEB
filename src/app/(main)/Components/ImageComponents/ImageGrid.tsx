...
import Styles from "@/app/(main)/styles/ImageGrid.module.css";
...
const ImageGrid = ({ images, layoutID }: props) => {
  ...
  return (
    <>
      ...
      <div className="mr-1 mt-1 cursor-pointer text-right font-medium text-stone-500 hover:text-blue-500 hover:underline">
        <button
          onClick={() => {
            setImageViewerState(true);
          }}
