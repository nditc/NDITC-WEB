...
const DataCard = () => {
  return (
    <div className="flex-1   w-full lg:w-0  flex flex-col md:flex-row lg:flex-col  gap-4">
      <div className="lg:h-1/2 flex-1 shadow-xl bg-[#1A6EFF] rounded-xl grid grid-cols-[1fr_auto] sm:grid-cols-[3fr_2fr] grid-rows-[auto_1fr] p-4 lg:p-6 text-white gap-3">
        ...
        <div className="col-start-1 row-start-2 self-end flex flex-col sm:gap-2">
          <p className="sm:text-lg lg:text-xl flex items-center">
            Intra Festival
            <span className="ml-3 font-extrabold">10</span>
          </p>
          <p className="sm:text-lg lg:text-xl flex items-center">
            Regional Festival
            <span className="ml-3 font-extrabold">20</span>
          </p>
          <p className="sm:text-lg lg:text-xl flex items-center">
            National Festival
            <span className="ml-3 font-extrabold">30</span>
          </p>
        </div>
        <div className="col-start-2 row-start-2 justify-self-end self-end text-right">
          <h3 className="text-7xl sm:text-8xl mt-4 lg:text-[10rem]  leading-[0.8]">45</h3>
          <p className="flex justify-end flex-col lg:gap-[.325rem] lg:flex-row sm:text-lg lg:text-xl leading-none ">
            Total <span>Events</span>
          </p>
        </div>
      </div>
      <div className="lg:h-1/2 flex-1 shadow-xl  bg-white grid grid-rows-2 grid-cols-[1fr_auto] p-3 lg:p-6 gap-4 rounded-xl items-center">
        <div className="bg-gray-100 h-full rounded-lg col-start-1 grid grid-cols-[auto_1fr_auto] p-3 lg:p-6 items-center lg:gap-3">
          ...
          />
          <p className="row-start-2 lg:row-start-1  sm:text-lg xl:text-xl leading-tight">
            Total <br />
            Members
          </p>
          <h4 className="row-span-2 justify-self-end  lg:row-span-1 text-5xl xl:text-6xl text-blue-500">
            219
          </h4>
        </div>
        <div className="bg-gray-100 h-full rounded-lg col-start-1 grid grid-cols-[auto_1fr_auto] p-3 lg:p-6 items-center lg:gap-3">
