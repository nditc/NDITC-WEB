  ...
  return (
    <div id="init" className="card flex flex-col relative">
      ...
      <div className="flex flex-1 flex-col justify-between h-full">
        <div className="p-5 pb-4 md:pb-6 flex flex-col justify-center gap-2 text-center">
          <h1 className="text-2xl min-h-[48px] md:min-h-[64px] grid place-items-center">{title}</h1>
