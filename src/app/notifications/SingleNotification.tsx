...
const SingleNotification = ({
  ...
  return (
    <Link
      href={`/notifications/details/${encodeURIComponent(detailsEncrypt.toString())}`}
      className="relative hover:cursor-pointer bg-white w-full h-[7.9rem] md:h-[8.6rem] border-gray-200 shadow-[5px_5px_30px_5px_#00000024] transition-all duration-500 hover:scale-105 rounded-xl flex justify-between"
    >
      {index == 0 && (
